...
def _env_recipe(env_cfg: I4bEnvConfig, building_name: str) -> dict:
    ...
    return {
        ...
        "process_noise_std": float(env_cfg.process_noise_std),
        "data_mode": env_cfg.data_mode,
        "valid_months": env_cfg.valid_months,
        "total_test_episodes": int(env_cfg.total_test_episodes),
        "split_seed": int(env_cfg.split_seed),
