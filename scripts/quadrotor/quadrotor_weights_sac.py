...
<<<<<<< HEAD:scripts/quadrotor/quadrotor_weights_sac.py
import datetime
...
if __name__ == "__main__":
    ...
    cfg.log.wandb_name = "quadrotor_tweights_sac"
    ...
    output_path = Path(f"output/quadrotor_weights/sac_{args.seed}_{datetime.datetime.now().strftime('%Y%m%d%H%M%S')}")
    main("sac", "quadrotor_terminal_weights", cfg, output_path, args.device)
