...
cfg.log.wandb_name = "refe_sac_fop"
...
output_path = Path(f"output/quadrotor_refe/sac_fop_{args.seed}_{datetime.datetime.now().strftime('%Y%m%d%H%M%S')}")
main("sac_fop", "quadrotor_refe", cfg, output_path, args.device)
