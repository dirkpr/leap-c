...
def compute_reference_position_circle(
    theta: float,
...
class ReacherEnv(ReacherEnvV5):
    ...
    def __init__(
        ...
        reference_position: str = "lemniscate",
        ...
        **kwargs,
        ...
        if reference_position == "circle":
            self.compute_reference_position = compute_reference_position_circle
        elif reference_position == "lemniscate":
