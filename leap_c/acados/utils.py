...
from acados_template import AcadosOcpSolver, AcadosOcpBatchSolver, AcadosOcp, AcadosSim, AcadosSimSolver
...
class AcadosFileManager:
    ...
    def setup_acados_ocp_solver(
        ...
        """Setup an acados ocp acados with path management.
        ...
        Returns:
            AcadosOcpSolver: The acados ocp acados.
        """
        ...
        # we add the acados file manager to the acados to ensure
        # the export directory is deleted when the acados is garbage collected
    ...
    def setup_acados_sim_solver(
        ...
        """Setup an acados sim acados with path management.
        ...
        Returns:
            AcadosSimSolver: The acados sim acados.
        """
    ...
    def setup_acados_ocp_batch_solver(
        ...
        Returns:
            AcadosOcpBatchSolver: The acados ocp batch acados.
        """
        ocp.code_export_directory = str(self.export_directory / "c_generated_code")
        json_file = str(self.export_directory / "acados_ocp.json")
